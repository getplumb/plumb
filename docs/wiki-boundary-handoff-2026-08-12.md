...
**Written** 2026-08-12 by a Claude Code session on Clay's host (Nukbox).
...
Clay noticed that a wiki page created that morning was not findable via `plumb_wiki_search`.
...
job-search material (`interviews/locusview-head-of-product.md`, `interviews/zapier-sdk-kei.md`,
`people/kevin-au.md`, `people/lauren-gilmore.md`, `people/ben-glickman.md`) and seven project
...
## 3. The policy decision (Clay's — authoritative, do not relitigate)

Clay wants the wiki boundary treated seriously: deliberate about what enters the wiki.

- **Raw transcripts of things Clay asks to be put in the wiki should live in the wiki tree**,
...
- **AIEWF 2026 is an explicit exception.** Those are third-party conference transcripts, not
  Clay's own material. They live at `~/aiewf-2026` and stay there. Only concepts and
...
- **No Anthropic API key, ever.** All model calls on this host go through Clay's subscription
...
## 8. Open decisions — ask Clay, do not decide these yourself
...
cd /home/openclaw-host/.openclaw/workspace/plumb
