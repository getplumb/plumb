...
Built as a self-hostable MCP server, Plumb runs locally with SQLite and sqlite-vec. No cloud required, no API calls. Source-available under the Elastic License 2.0.
...
- **Elastic License 2.0**: Source-available, self-hostable, no vendor lock-in
