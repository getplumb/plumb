...
Plumb 2.0 adds a persistent, LLM-maintained wiki layer to the existing Plumb memory system. The wiki is a structured, interlinked collection of markdown files that compounds over time, covering every domain of Alex's life. It sits alongside Plumb V1 (the fact store), not replacing it. Together, they form a three-mode retrieval system:
...
tags: [northwind, interview, ai-platform]
confidence: high                      # high | medium | low
---
# Jordan Lee

Head of AI Platform at [[Northwind]]. Joined from [[Brightline]].

## Role
Leads 30 engineers across two pillars...

## Interview Notes
Alex interviewed with Jordan on 2026-03-23. See [[Northwind Loop Interview]].

## Key Quotes
- "I think of myself like a PM agent, like a sports agent. How do I get my PMs paid."
- On fun: "At Brightline, building products is solving for everyone — boiling the ocean. At Northwind, you deliver a more powerful product."
...
- Updated: companies/northwind.md — added AI platform team structure
- Updated: index.md — 3 new entries
- Contradiction resolved: interviews/northwind-loop.md — updated panel debrief date from April 6 to April 7
...
[PLUMB WIKI]
## Relevant wiki pages
[HIGH] people/jordan-lee.md — Head of AI Platform at Northwind, interviewed 2026-03-23
[HIGH] interviews/northwind-loop.md — Loop interview intel, formats, focus areas by interviewer
[MED] companies/northwind.md — AI platform team, 30 engineers, Agent Studio
...
2. **Instant Response:** The tool instantly returns "Edit queued", allowing Terra to reply to Alex with zero latency.
...
- Alex can review this file at his leisure. If the AI hallucinated or updated something incorrectly, he can manually correct it or ask Terra to revert it.
...
Alex reviews before switching to `v2-shadow` mode.
...
2. **Auto-Re-embed:** If Alex manually edited a file in Obsidian, the hash will mismatch. The system automatically re-embeds that specific file before proceeding, ensuring the vector index is always perfectly synced with the filesystem.
...
- [ ] Alex decision: switch to v2 or continue shadow
...
1. **Coverage:** Wiki has pages for all major entities Alex has discussed (people, companies, projects, interviews)
...
5. **Browsability:** Alex can open `~/.plumb/wiki/` in Obsidian and navigate it usefully
...
4. **Multi-session standing prompt:** If Alex has conversations across terra-chat and Slack, do both trigger standing prompt updates?
5. **Manual edits:** When Alex edits a wiki page directly, how does the system detect and re-embed the change?
