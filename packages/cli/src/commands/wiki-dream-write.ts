...
### person
# Full Name
One-line summary (role + relationship to the user).
## Role
## Background
...
- Every new page must explain why the entity belongs in the user's wiki: its relationship to the user, Terra, OpenClaw/Plumb, or another existing page.
