 ...
 *             people/alex-rivera.md on 2026-04-24).
...
4. Return secondary_mentions only if the fact would meaningfully update OTHER pages too (e.g. "the user got promoted" might update both alex-rivera.md AND his employer's page). Most facts have no secondary mentions.
...
function resolveOpenClawGatewayToken(): string {
  ...
  const provider = process.env.PLUMB_SECRET_PROVIDER;
