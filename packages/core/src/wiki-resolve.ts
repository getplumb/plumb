 ...
 * `[[the user]]` → people/alex-rivera.md, `[[Dana Rivera]]` → people/dana.md,
 ...
 *
 * This is what closes the largest real defect class on the user's wiki. Pages are
 * filed under kebab-case names (`people/morgan-ellis.md`) but linked by
 * display name (`[[Morgan Ellis]]`), and the H1 is often a role rather than
 * the person's name ("Northwind Principal PM – Maintenance"), so neither the stem
...
export interface WikiPageInput {
  /** Wiki-root-relative path, e.g. `people/priya.md`. */
  readonly rel: string;
...
export function resolveWikilink(
  ...
  // have 15 live instances on companies/latchkey.md, but every one of them was a
