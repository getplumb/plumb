...
describe('parseSimpleYaml', () => {
  ...
  test('parses block arrays', () => {
    ...
    assert.deepEqual(result.tags, ['interview', 'northwind']);
  });

  test('parses inline arrays', () => {
    const result = parseSimpleYaml('tags: [interview, northwind]');
    assert.deepEqual(result.tags, ['interview', 'northwind']);
  });
...
`;
    ...
    assert.deepEqual(frontmatter.tags, ['interview', 'northwind']);
...
describe('readWikiPage / writeWikiPage', () => {
  ...
  test('writes and reads back a page correctly', async () => {
    ...
    assert.deepEqual(page.frontmatter.tags, ['interview', 'northwind']);
