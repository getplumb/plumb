...
// surface model (injection queries with the user's raw last message; agent-mcp-search/
...
const DB = process.env.BENCH_DB
  || fileURLToPath(new URL('../../../../plumb-benchmark/real-wiki/artifacts/v7-snapshot-20260807/wiki.db', import.meta.url))
const CASES = process.env.EVAL_CASES_FILE
  || fileURLToPath(new URL('../../../../plumb-benchmark/real-wiki/cases/challenge.train.v7.json', import.meta.url))
